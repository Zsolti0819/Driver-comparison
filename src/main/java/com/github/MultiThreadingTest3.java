...
/**
 * This case tests parallel insert when there is conflict between tables. Inserts are committed at once at the end. 9
 * out of 10 threads will be stopped due PessimisticLockException, and only one thread's inserts will be persisted and
 * committed.
 */
